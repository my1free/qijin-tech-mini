// pages/publisher/my-company/company-search/company-search.js
...
Page({
  ...
  doSearch: function() {
    if (common.companySearch(this, this.data.keyword)) {
      this.setData({
        clicked: true
      })
    }
  ...
  addBelongedCompany: function(e){
    var companyId = e.currentTarget.dataset.id
    console.log("[addBelongedCompany] companyId=", companyId)
    common.addBelongedCompany(this, companyId)
  },

  addCompany: function() {
    wx.navigateTo({
      url: '/pages/publisher/my-company/company-edit/company-edit',
    })
  }
})